...
{
    [Route("api/report/order/reload")]
    [ApiController]
    [ApiExplorerSettings(GroupName = "report_v1")]
    public class ReportOrderReloadController : ControllerBase
    {
        IOrderReloadReport assetService;
        EprocClient _epClient;

        public ReportOrderReloadController(IOrderReloadReport assetService, EprocClient epClient)
        {
